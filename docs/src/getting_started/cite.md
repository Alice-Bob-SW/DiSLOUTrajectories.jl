# [Cite DiSLOUTrajectories.jl](@id doc-Cite)

If you found `DiSLOUTrajectories.jl` useful, we would appreciate it if you could cite our publication [ [ArXiv](https://arxiv.org/) ] using the following bibtex entry:
